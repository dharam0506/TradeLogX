        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-400">
              Whether you're curious about features, need support, or want to explore partnership opportunities—we'd love to hear from you.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400">info@tradediary.in</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      href="https://www.instagram.com/tradediary.in/"
                      target="_blank"
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h4 className="text-white font-semibold mb-1">WhatsApp (Text Only)</h4>
                    <a
                      href="https://wa.me/919405893959"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-400 hover:text-blue-300"
                    >
                ...
                <div className="pt-6 border-t border-slate-700">
                  <h4 className="text-white font-semibold mb-3">Our office hours</h4>
                  <p className="text-slate-400 mb-1">Monday - Friday: 9:00 AM - 6:00 PM IST</p>
                  <p className="text-slate-400">Saturday: 10:00 AM - 2:00 PM IST</p>
                </div>
              </div>
            </div>
          </div>
